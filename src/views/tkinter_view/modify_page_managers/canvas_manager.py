...
class CanvasManager:
    def __init__(self, modify_page):
        """Initialize CanvasManager with a reference to ModifyPage and create the canvas."""
    ...
    def clear_canvas(self):
        ...
        self.node_drawings.clear()
        self.edge_drawings.clear()
    ...
    def select_element(self, element_id):
        ...
        self.modify_page.element_selected(self.convert_element_id_to_input_id(element_id), self.get_element_type(element_id))
